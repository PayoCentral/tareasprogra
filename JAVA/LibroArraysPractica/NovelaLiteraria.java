public class NovelaLiteraria extends Novela{
    ...
    public NovelaLiteraria(String Titulo, String Autores, float precio, String Tema, String Epoca){
    ...
    public static void imprimeLibro(NovelaLiteraria novelaliteria){
